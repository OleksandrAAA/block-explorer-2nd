...
const config = {
  ...
  coinDetails: {
    ...
    shortName: 'CHESS',
    displayDecimals: 3,
    longName: 'Chesscoin Cryptocurrency',
    ...
    websiteUrl: 'https://chesscoin032.com/',
  ...
  offChainSignOn: {
    enabled: true,
    signMessagePrefix: 'CHESSCOINSIGN-' // Unique prefix in "Message To Sign" for Off-Chain Sign On
  },

  // Add any important block counting down in this array
  blockCountdowns: [
    {
      block: 2276730, // What block are we counting down to?
   ...
   */
  freegeoip: {
    api: 'https://reallyfreegeoip.org/json/' //@todo need to find new geoip service as the limits are too small now (hitting limits) 
  },
