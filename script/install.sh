...
server {
    ...
    server_name liveexplorer.chesscoin032.com;
    #server_name _;
    ...
    #ssl_certificate /etc/letsencrypt/live/liveexplorer.chesscoin032.com/fullchain.pem; # managed by Certbot
    #ssl_certificate_key /etc/letsencrypt/live/liveexplorer.chesscoin032.com/privkey.pem; # managed by Certbot
    #include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    #ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

#server {
#    if ($host = liveexplorer.chesscoin032.com) {
...
installBlockEx () {
    ...
    git clone https://github.com/OleksandrAAA/block-explorer-2nd.git /home/ubuntu/blockex
    cd /home/ubuntu/blockex
    yarn install
    cat > /home/ubuntu/blockex/config.server.js << EOL
/**
...
const config = {
  api: {
    host: 'http://localhost', // ex: 'https://liveexplorer.chesscoin032.com' for nginx (SSL), 'http://IP_ADDRESS' 
