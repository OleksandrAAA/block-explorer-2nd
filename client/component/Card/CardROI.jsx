...
const CardROI = ({ coin }) => {
  ...
  return (
    <Card>
      ...
      <div className="mb-3">
        <div className="h3">
          { numeral(coin.supply ? coin.supply : 0.0).format('0,0.0000') } CHESS
        </div>
        <div className="h5">
          Coin Supply (Total)
        </div>
      ...
      <div className="mb-3">
        <div className="h3">
          { numeral(coin.supply ? coin.supply - (mns * mncoins) : 0.0).format('0,0.0000') } CHESS
        </div>
        <div className="h5">
      ...
      <div className="mb-5">
        <div className="h3">
          { numeral(mns * mncoins).format('0,0.0000') } CHESS
        </div>
        <div className="h5">
          Coins Locked
        </div>
